...
podman run -p 9090:9090 -p 3000:3000 --name postgresql-grafana -d -e PG_USER_NAME=monuser -e PG_USER_PASSWORD=monpass -e PG_NETWORK_MASK=all -e PG_MONITOR1=192.168.1.12:9100 -e PG_MONITOR2=192.168.1.12:9187 pgsql14-grafana-rocky8
